...
Java_fun_walawe_memelm_gguf_GGUFReader_getGGUFContextNativeHandle(JNIEnv* env, jobject /*thiz*/, jstring modelPath) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_fun_walawe_memelm_gguf_GGUFReader_getContextSize(JNIEnv* env, jobject /*thiz*/, jlong nativeHandle) {
...
Java_fun_walawe_memelm_gguf_GGUFReader_getChatTemplate(JNIEnv* env, jobject /*thiz*/, jlong nativeHandle) {
    auto* ggufContext = reinterpret_cast<gguf_context*>(nativeHandle);
    if (!ggufContext) {
